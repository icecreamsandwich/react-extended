                ...
                <nav>
                    <div className="nav-wrapper grey lighten-5">
                        ...
                        <ul className="right hide-on-med-and-down">
                            ...
                            <li><a className="black-text" href="/manager/uiTabs">UiTabs</a></li>
                            <li><a className="black-text" href="/manager/lorem">Lorem</a></li>
                            <li><a className="black-text" href="/manager/scheduler">Scheduler<i className="material-icons right">access_time</i></a></li>
